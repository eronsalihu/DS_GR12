...
public class Playfair {
    ...
    public static void main(String args[]) {
        ...
        String input = scan.nextLine();
            ...
            if(input.equals("ds playfair encrypt")) {
           ...
           else if(input.equals("ds playfair encrypt table")) {
                keyword = scan.nextLine();
                ciphertext = scan.nextLine();
            ...
            else if(input.equals("ds playfair decrypt")) {
                keyword = scan.nextLine();
                ciphertext = scan.nextLine();
            ...
            else if(input.equals("ds playfair decrypt table")) {
                keyword = scan.nextLine();
                ciphertext = scan.nextLine();
